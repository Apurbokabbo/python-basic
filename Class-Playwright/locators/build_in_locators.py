...
class TestBuildInLocators:
    ...
    def test_get_by_label(self):
        ...
        time.sleep(3)
        self.page.get_by_label("Personal Email").fill("GTA@noemail.com")
        time.sleep(3)
        self.page.get_by_label("Marital Status").select_option("Married")
        time.sleep(3)

    def test_get_by_text(self):
        self.page.get_by_text("First Name").fill("GTA")
        time.sleep(3)

    def test_get_by_placeholder(self):
        self.page.get_by_placeholder("ID Number").fill("GTA-12735217")
        time.sleep(3)
